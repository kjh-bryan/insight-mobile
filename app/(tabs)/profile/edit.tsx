...
import { router } from 'expo-router';
  ...
  export default function EditProfileScreen() {
    const { userId, name, username, email, password } = useSelector((state: RootState) => state.user);
    ...
    return (
      ...
      >
        ...
        <Button
          ...
          onPress={async() => {
            try {
              const result = await updateUser(Number(userId), usernameForm, passwordForm, emailForm, nameForm);
              if (result) {
                console.log('User Screen result:', result);
                updateSuccess();
                setUserInfo(Number(userId), nameForm, usernameForm, emailForm, passwordForm);
              } else {
